...
public class Strings {
	...
	public void String_opr() {
		String sPopularTopic_1 = "Selenium Automation Framework";
		  ...
		  String sSubString = sPopularTopic_1.substring(22);
		  ...
		  System.out.println("The second part of the array is : " + aSplit[1]);
